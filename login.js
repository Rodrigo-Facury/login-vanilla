...
function handleChange() {
    ...
    if(email){
        if(!validateEmail()){
            generateNotification("Formato inválido de e-mail!", "notificacao-invalida-email", false)
        }else{
            clearNotification("notificacao-invalida-email")
        }
    }

    if(password){
        if(!validatePassword()){
            generateNotification("A senha não é valida!", "notificacao-invalida-password", false)
        }else{
            clearNotification("notificacao-invalida-password")
        }
    }
